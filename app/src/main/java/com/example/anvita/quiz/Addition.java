...
public class Addition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(phone){
            ...
            if(orientation == 0 || orientation == 2)
                ...
                setContentView(R.layout.activity_addition_landscape);
        }


        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
      //  getSupportActionBar().setHomeAsUpIndicator(R.drawable.abacus);
        ...
        final TextView tv_timer = (TextView) findViewById(R.id.tv_counter_add);
        ...
        final TextView num1 = (TextView) findViewById(R.id.tv_addnum1);
        num1.setText(String.valueOf(n1));

        final TextView num2 = (TextView) findViewById(R.id.tv_addnum2);
    ...
    public void buttonPress(View v)
    {
        ...
        if (!buttonNum.equals("Next")) {
            sumnum = sumnum + buttonNum;

            ansGlobal = sumnum;

            final EditText ansview = (EditText) findViewById(R.id.et_add_answer);
            ansview.setText(sumnum);

            int ans = Integer.valueOf(sumnum);
